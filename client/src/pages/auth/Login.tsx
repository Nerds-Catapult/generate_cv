  ...
  const AuthFormt = () => (
    ...
    <div className=" h-full w-full flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col space-y-4 mt-10">
        ...
        {/* login in with third parties */}
        <div className="w-full flex flex-col items-center space-y-2">
          <button className="active:border-none hover:border-none transition ease-in-out duration-200 hover:bg-white hover:text-cyan-600 active:bg-pink-500 active:text-white w-40 text-sm text-white border border-white p-2 rounded-full  " >Login with google</button>
          <button className="active:border-none hover:border-none transition ease-in-out duration-200 hover:bg-white hover:text-cyan-600 active:bg-pink-500 active:text-white w-40 text-sm text-white border border-white p-2 rounded-full  " >Login with facebook</button>
          <button className="active:border-none hover:border-none transition ease-in-out duration-200 hover:bg-white hover:text-cyan-600 active:bg-pink-500 active:text-white w-40 text-sm text-white border border-white p-2 rounded-full  " >Login with github</button>
        </div>
      </div>
    </div>
    </>
